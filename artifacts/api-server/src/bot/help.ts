...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "!noprefix set", desc: "Enable noprefix for **everyone** in the server." },
      { name: "!noprefix set @role", desc: "Enable noprefix for a specific role only." },
      { name: "!noprefix remove", desc: "Disable noprefix for this server." },
